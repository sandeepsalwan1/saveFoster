  ...
  return (
    <header className="relative z-40 bg-white shadow-sm">
      <div className="container mx-auto px-4 py-4 flex items-center justify-between">
        <Link href="/" className="text-2xl font-bold text-[#1e2029]" aria-label="Save The Foster home">
          Save The Foster
        </Link>
        ...
        <div className="flex items-center gap-4">
          <Button asChild className="bg-[#1e2029] hover:bg-[#2a2d3a] text-white transition-colors">
