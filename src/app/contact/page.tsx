...
export default function Contact() {
  return (
    <main id="main-content" className="min-h-screen">
      ...
      <section className="relative isolate overflow-hidden py-24">
        ...
        <div className="container mx-auto px-4 text-center">
          <div className="mx-auto max-w-lg rounded-2xl bg-white/95 p-8 shadow-xl backdrop-blur-sm">
            <h1 className="mb-4 text-4xl font-bold text-[#2a316b]">Get Involved</h1>
            <p className="mb-6 text-lg leading-relaxed text-gray-700">
              Ask a question, volunteer, or explore a partnership with Save The Foster.
            </p>
            <Button asChild className="bg-[#2a316b] text-white hover:bg-[#1e2456]">
              <a href="#contact-form">Start a Message</a>
            </Button>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="mx-auto max-w-2xl">
            ...
            <p className="mb-8 text-center leading-relaxed text-gray-600">
              Complete the form and your email app will open with the message ready for you to review and send.
            </p>
            <ContactForm />
          </div>
        </div>
      ...
      <section className="bg-white py-16" aria-labelledby="other-contact-heading">
        <div className="container mx-auto px-4 text-center">
          <h2 id="other-contact-heading" className="mb-8 text-2xl font-bold text-[#2a316b]">
            Other Ways to Reach Us
          </h2>

          <div className="mx-auto grid max-w-4xl gap-8 md:grid-cols-3">
            <div className="p-6">
              <Mail aria-hidden="true" className="mx-auto mb-4 h-16 w-16 rounded-full bg-[#2a316b] p-4 text-white" />
              <h3 className="mb-2 text-lg font-semibold text-[#2a316b]">Email</h3>
              <a href={`mailto:${siteConfig.email}`} className="text-[#2a316b] hover:underline">
                {siteConfig.email}
              </a>
            </div>

            <div className="p-6">
              <MapPin aria-hidden="true" className="mx-auto mb-4 h-16 w-16 rounded-full bg-[#2a316b] p-4 text-white" />
              <h3 className="mb-2 text-lg font-semibold text-[#2a316b]">Location</h3>
            ...
            <div className="p-6">
              ...
              <h3 className="mb-3 text-lg font-semibold text-[#2a316b]">Follow Our Work</h3>
