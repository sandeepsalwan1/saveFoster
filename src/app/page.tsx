...
import { createPageMetadata, siteConfig, websiteJsonLd } from "@/lib/site";
  ...
  return (
    <main id="main-content" className="min-h-screen">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="order-2 md:order-1">
              ...
              <p className="text-lg md:text-xl text-gray-600 mb-8 leading-relaxed max-w-lg">
                We are a Bay Area nonprofit supporting foster youth, vulnerable
                children, and humanitarian efforts locally and globally.
              </p>
              <Button
                asChild
                className="bg-[#1e2029] hover:bg-[#2a2d3a] text-white text-lg px-8 py-3 transition-colors"
              >
      ...
      <section className="bg-[#5d6396] py-10">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="max-w-4xl mx-auto text-white text-lg leading-relaxed space-y-4">
            <p>
              Your donation supports our humanitarian work and may be tax
              deductible to the extent allowed by law.
            </p>
            <p>
              Please email us at{" "}
              <a
                href="mailto:savethefoster@gmail.com"
                className="underline hover:no-underline"
              >
                savethefoster@gmail.com
              </a>{" "}
              after contributing so we can send you an acknowledgment letter for
              your tax purposes.
            </p>
          </div>
        </div>
      ...
      <section className="py-0">
        <div className="grid grid-cols-1 md:grid-cols-3">
          ...
          <div
            ...
            style={{
              backgroundImage:
                'linear-gradient(rgba(0,0,0,0.5), rgba(0,0,0,0.5)), url("/images/4.webp")',
          ...
          >
            <div className="absolute inset-0 flex flex-col justify-center items-center text-white p-6 md:p-8 text-center">
              ...
              <p className="text-base md:text-lg leading-relaxed max-w-xs">
                Strong communities start with local action. We support Bay Area
                youth through education, practical resources, and volunteer-led
                programs.
              </p>
            </div>
          </div>
          ...
          <div
            ...
            style={{
              backgroundImage:
                'linear-gradient(rgba(0,0,0,0.5), rgba(0,0,0,0.5)), url("/images/5.webp")',
              backgroundSize: "cover",
              backgroundPosition: "center",
              backgroundRepeat: "no-repeat",
            }}
          >
            <div className="absolute inset-0 flex flex-col justify-center items-center text-white p-6 md:p-8 text-center">
              ...
              <p className="text-base md:text-lg leading-relaxed max-w-xs">
                We are a local nonprofit committed to helping foster youth and
                vulnerable children. Giving young people practical support and
                opportunity is our highest priority.
              </p>
            </div>
          </div>
          ...
          <div
            ...
            style={{
              backgroundImage:
                'linear-gradient(rgba(0,0,0,0.5), rgba(0,0,0,0.5)), url("/images/6.webp")',
              backgroundSize: "cover",
              backgroundPosition: "center",
              backgroundRepeat: "no-repeat",
            }}
          >
            <div className="absolute inset-0 flex flex-col justify-center items-center text-white p-6 md:p-8 text-center">
              ...
              <p className="text-base md:text-lg leading-relaxed max-w-xs">
                Contributions support programs and humanitarian projects that
                help foster youth and vulnerable children build healthier, more
                secure futures.
              </p>
            </div>
          </div>
      ...
      <section className="py-10 bg-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-gray-500 mb-6 max-w-xl mx-auto">
            Cleft surgery missions and surgical supply support with Rotaplast
            International
          </p>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-5xl mx-auto">
            ...
            <Image
              ...
              alt="Rotaplast volunteer with a mother and child"
              width={3896}
              height={4653}
              sizes="(max-width: 768px) 46vw, 280px"
              className="rounded-xl shadow-md w-full h-48 md:h-56 object-cover"
            />
            <Image
              src="/images/bangladesh/suture-donation-team.jpg"
              alt="Save The Foster volunteers with donated suture materials"
              width={4032}
              height={3024}
              sizes="(max-width: 768px) 46vw, 280px"
              className="rounded-xl shadow-md w-full h-48 md:h-56 object-cover"
          ...
          <Button
            asChild
            className="mt-8 bg-[#2f3257] hover:bg-[#3d4170] text-white text-lg px-8 py-3"
          >
      ...
      <section
        ...
        style={{
          backgroundImage:
            'linear-gradient(rgba(0,0,0,0.6), rgba(0,0,0,0.6)), url("/images/7.webp")',
        }}
      >
