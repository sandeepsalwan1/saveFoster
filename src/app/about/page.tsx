...
export default function About() {
  return (
    <main id="main-content" className="min-h-screen">
      <JsonLd data={founderProfileJsonLd} />
      <Header />
        ...
        <div className="container relative mx-auto grid max-w-6xl items-center gap-12 px-4 py-16 md:grid-cols-[1.1fr_0.9fr] md:py-24">
          <div className="order-2 md:order-1">
            ...
            <p className="max-w-xl text-lg leading-relaxed text-white/80">
              Sonia founded Save The Foster to bring compassionate, practical
              support to children and communities in need. As a veterinarian,
              she brings a care-centered perspective to the organization&apos;s
              humanitarian work locally and globally.
            </p>
          </div>
      ...
      <section className="py-0">
        <div className="grid md:grid-cols-2">
          ...
          <div
            ...
            style={{
              backgroundImage:
                'linear-gradient(rgba(0,0,0,0.3), rgba(0,0,0,0.3)), url("/images/13.webp")',
            }}
          >
          ...
          <div
            ...
            style={{
              backgroundImage:
                'linear-gradient(rgba(0,0,0,0.3), rgba(0,0,0,0.3)), url("/images/14.webp")',
            }}
          >
            <div className="absolute inset-0 flex flex-col justify-center items-center text-white p-8 text-center">
              <h2 className="text-4xl md:text-5xl font-bold mb-4">
      ...
      <section className="bg-[#293778] py-16">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-4xl font-bold text-white mb-6">A Bit About Us</h2>
          ...
          <div className="max-w-4xl mx-auto text-white text-lg leading-relaxed">
            <p className="mb-6">
              At Save the Foster, we are a group of diverse volunteers who seek
              to help foster kids. We want to be a catalyst for positive change,
              and since our beginnings in Early 2022, we've been driven by the
              same ideas we initially founded our Non-Profit Organization upon:
              support, empowerment, and progress.
            </p>
            <p className="mb-8">
              Learn more about our mission, our vision, and how we go about
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h3 className="text-3xl font-bold text-[#293778] mb-6">
                Mission
              </h3>
              <div className="space-y-4 text-gray-700 leading-relaxed">
                <p>
                  We believe in Humanitarian help. Our efforts are to help
                  Humanitarian causes locally and globally. We give financial
                  assistance and voluntary efforts to uplift humanity.
                </p>
                <p>
                  Passionate about helping children, foster kids, and children
                  rescued from sex trafficking. Provides efforts to help improve
                  mental and physical health and well-being of children.
                </p>
              </div>
            </div>
            <div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Providing comprehensive support to foster children and families
                in need.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <h4 className="text-xl font-bold text-[#293778] mb-2">
                Empowerment
              </h4>
              <p className="text-gray-600">
                Empowering youth through education, resources, and
                opportunities.
              </p>
            </div>
